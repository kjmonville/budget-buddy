        ...
        NavigationStack {
            List {
                ...
                HelpSection(
                    ...
                    bodyText: "Each day on the calendar shows a projected end-of-day balance — what your account should look like after all of that day's transactions have cleared.\n\nBudget Buddy works forward from today only. Past days don't show a projected balance — only today and future dates do.",
                ...
                HelpSection(
                    ...
                    bodyText: "Swipe left or right to move between months. Each day cell shows any transactions scheduled for that day, along with the projected balance after they're applied.\n\nTap any transaction badge in a day cell to mark it as cleared (more on that below).",
                ...
                HelpSection(
                    ...
                    bodyText: "One-time transactions (also called adhoc transactions) are for things that happen on a specific date and don't repeat. A car registration renewal, a birthday dinner, or a one-off freelance payment are all good examples.\n\nThey appear on the calendar only on the date you choose.",
                ...
                HelpSection(
                    title: "Cleared",
                    bodyText: "Tapping a transaction badge marks it as cleared — meaning it has already come out of (or landed in) your real bank account. The transaction appears struck-through and is excluded from the balance projection, since your starting balance already reflects it.\n\nTap a cleared transaction again to restore it to the projection.",
